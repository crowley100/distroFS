...
/* package lock-service-0.1.0.0 */
#define VERSION_lock_service "0.1.0.0"
#define MIN_VERSION_lock_service(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lock-service-0.1.0.0-AQaynlu4vrQ4vao3OQo85d"

#define CURRENT_PACKAGE_KEY "lock-service-0.1.0.0-AQaynlu4vrQ4vao3OQo85d"
